...
#  FT "Storage(HDD4)" "$DIAG_NAME -drv sde -interval 1000"
#  FT "Storage(HDD5)" "$DIAG_NAME -drv sdf -interval 1000"


#Memory
#DIAG_NAME=memtest
#if [ "$STATION" == "FAT" ] || [ "$STATION" == "FFT" ] || [ "$STATION" == "FQA" ] || [ "$STATION" == "OBE" ]; then      
#   FT "Memory" "$DIAG_NAME --module 1 --size 512000"          #500M=500*1024=512000 Byte
