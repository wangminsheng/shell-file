...
# [ 16 ]============================ record SEL log ===================================
echo "------record sel list to testlog-----------" >>$Logfile
ipmitool sel elist -v >>$Logfile
echo "-------------------------------------------" >>$Logfile
echo "" >>$Logfile
echo "------record sdr list  to testlog----------" >>$Logfile
...
# [ 18 ]=======set chassis policy always-off====================================
